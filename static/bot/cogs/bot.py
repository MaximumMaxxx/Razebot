...
from discord.ext import commands, ipc # Commands for said discord integration
...
# initialize the bot
bot = Bot(command_prefix=">", help_command=None,intents= discord.Intents.default())

@bot.ipc.route()
async def get_guild_count(data):
    return len(bot.guilds) # Amount of guilds the client is in
